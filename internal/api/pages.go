  ...
  <body class="bg-zinc-950 text-zinc-100 min-h-screen flex items-center justify-center antialiased">
    <div class="max-w-lg w-full mx-auto px-6 py-16">
      ...
      <div class="rounded-xl bg-zinc-900/60 border border-zinc-800 p-5 mb-4">
        ...
        <p class="text-sm text-zinc-500 leading-relaxed">The browser UI is under development. Use the <a href="https://github.com/getsecrt/secrt" class="text-emerald-400/80 hover:text-emerald-400 underline decoration-zinc-700 hover:decoration-emerald-400/40 transition-colors">CLI</a> or API to create and claim secrets.</p>
      </div>
