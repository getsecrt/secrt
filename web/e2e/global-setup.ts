...
export default async function globalSetup() {
  ...
  const server: ChildProcess = spawn(serverBin, [], {
    env: {
      ...
      DATABASE_URL,
      API_KEY_PEPPER: 'e2e-api-key-pepper',
      SESSION_TOKEN_PEPPER: 'e2e-session-token-pepper',
      RUST_LOG: 'warn',
      ...
      CLAIM_RATE: '10',
      CLAIM_BURST: '50',
      APIKEY_REGISTER_RATE: '10',
      APIKEY_REGISTER_BURST: '50',
      APIKEY_REGISTER_ACCOUNT_MAX_PER_HOUR: '500',
      APIKEY_REGISTER_ACCOUNT_MAX_PER_DAY: '5000',
      APIKEY_REGISTER_IP_MAX_PER_HOUR: '500',
      APIKEY_REGISTER_IP_MAX_PER_DAY: '5000',
    },
