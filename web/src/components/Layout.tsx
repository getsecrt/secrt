...
export function Layout({ children }: LayoutProps) {
  ...
  return (
    <div class="flex min-h-screen flex-col items-center px-4 py-8">
      ...
      <footer class="mt-8 flex flex-col items-center text-faint">
        <div class="group flex flex-col items-center justify-center hover:text-muted">
          <a href="https://github.com/getsecrt/secrt">
            <svg
              viewBox="0 0 128 128"
              xmlns="http://www.w3.org/2000/svg"
              class="size-8 hover:text-muted"
            >
              <path
          ...
          <a
            class="mb-2 underline-offset-3 group-hover:underline hover:text-muted"
